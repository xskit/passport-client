 ...
 * @method static HttpRequestContract request($api = null, array $guzzle = []) api请求
 * @method static HttpRequestAsyncContract requestAsync($api = null, array $guzzle = []) api异步请求
